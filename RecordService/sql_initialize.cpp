...
void SqlInitialize::createAccountTypeTable() {
  ...
  QSqlQuery query;
  if (!query.exec("CREATE TABLE IF NOT EXISTS 'AccountType' ("
                  "   'type' TEXT NOT NULL,"
                  "   PRIMARY KEY(type)"
                  ")")) {
...
void SqlInitialize::createAccountStatusTable() {
  ...
  QSqlQuery query;
  if (!query.exec("CREATE TABLE IF NOT EXISTS 'AccountStatus' ("
...
void SqlInitialize::createDeviceTypeTable() {
  ...
  QSqlQuery query;
  if (!query.exec("CREATE TABLE IF NOT EXISTS 'DeviceType' ("
                  "   'type' TEXT NOT NULL,"
                  "   PRIMARY KEY(type)"
                  ")")) {
    qFatal("Failed to query database: %s",
...
void SqlInitialize::createDeviceStatusTable() {
  ...
  QSqlQuery query;
  if (!query.exec("CREATE TABLE IF NOT EXISTS 'DeviceStatus' ("
                  "   'status' TEXT NOT NULL,"
                  "   PRIMARY KEY(status)"
                  ")")) {
    qFatal("Failed to query database: %s",
...
void SqlInitialize::createDeviceVadTable() {
  ...
  QSqlQuery query;
  if (!query.exec("CREATE TABLE IF NOT EXISTS 'DeviceVAD' ("
                  "   'vad' TEXT NOT NULL,"
                  "   PRIMARY KEY(vad)"
                  ")")) {
    qFatal("Failed to query database: %s",
...
void SqlInitialize::createConferencTypeTable() {
  ...
  QSqlQuery query;
  if (!query.exec("CREATE TABLE IF NOT EXISTS 'ConferenceType' ("
                  "   'type' TEXT NOT NULL,"
                  "   PRIMARY KEY(type)"
                  ")")) {
    qFatal("Failed to query database: %s",
...
void SqlInitialize::createConferencsTable() {
  ...
  QSqlQuery query;
  if (!query.exec("CREATE TABLE IF NOT EXISTS 'Conferencs' ("
                  "   'uuid' TEXT NOT NULL,"
                  "   'type' TEXT NOT NULL,"
                  "   'title' TEXT NOT NULL,"
...
void SqlInitialize::createFileTypeTable() {
  ...
  QSqlQuery query;
  if (!query.exec("CREATE TABLE IF NOT EXISTS 'FileType' ("
                  "   'type' TEXT NOT NULL,"
                  "   PRIMARY KEY(type)"
                  ")")) {
    qFatal("Failed to query database: %s",
...
void SqlInitialize::createFileSuffixTable() {
  ...
  QSqlQuery query;
  if (!query.exec("CREATE TABLE IF NOT EXISTS 'FileSuffix' ("
