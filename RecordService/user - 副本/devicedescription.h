...
{
    Q_OBJECT
    Q_DISABLE_COPY(DeviceDescription)
    Q_DECLARE_PRIVATE(DeviceDescription)
...
protected:
    DeviceDescription(DeviceDescriptionPrivate *d, QObject *parent = 0);
    QScopedPointer<DeviceDescriptionPrivate> d_ptr;
};
