...
#include "../../../RecordService/user/user.h"
...
QT_MOC_LITERAL(1, 5, 13), // "userIdChanged"
QT_MOC_LITERAL(2, 19, 0), // ""
QT_MOC_LITERAL(3, 20, 6), // "userId"
QT_MOC_LITERAL(4, 27, 16), // "userGroupChanged"
QT_MOC_LITERAL(5, 44, 9), // "userGroup"
QT_MOC_LITERAL(6, 54, 15), // "userNameChanged"
QT_MOC_LITERAL(7, 70, 8), // "userName"
QT_MOC_LITERAL(8, 79, 9), // "setUserId"
QT_MOC_LITERAL(9, 89, 12), // "setUserGroup"
QT_MOC_LITERAL(10, 102, 11) // "setUserName"

    },
    "User\0userIdChanged\0\0userId\0userGroupChanged\0"
    "userGroup\0userNameChanged\0userName\0"
    "setUserId\0setUserGroup\0setUserName"
};
...
void User::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->userGroupChanged((*reinterpret_cast< const QString(*)>(_a[1]))); break;
        case 2: _t->userNameChanged((*reinterpret_cast< const QString(*)>(_a[1]))); break;
        case 3: _t->setUserId((*reinterpret_cast< QString(*)>(_a[1]))); break;
        case 4: _t->setUserGroup((*reinterpret_cast< QString(*)>(_a[1]))); break;
        ...
        {
            typedef void (User::*_t)(const QString & );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&User::userIdChanged)) {
                *result = 0;
                return;
            }
        }
        {
            typedef void (User::*_t)(const QString & );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&User::userGroupChanged)) {
                *result = 1;
                return;
            }
        }
        ...
        case 1: *reinterpret_cast< QString*>(_v) = _t->userGroup(); break;
        ...
        case 1: _t->setUserGroup(*reinterpret_cast< QString*>(_v)); break;
...
// SIGNAL 0
void User::userIdChanged(const QString & _t1)
{
...
// SIGNAL 1
void User::userGroupChanged(const QString & _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(&_t1)) };
...
// SIGNAL 2
void User::userNameChanged(const QString & _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(&_t1)) };
