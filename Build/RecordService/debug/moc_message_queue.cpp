/****************************************************************************
** Meta object code from reading C++ file 'message_queue.h'
**
...
#include "../../../RecordService/websocket/message_queue.h"
#include <QtCore/qbytearray.h>
#include <QtCore/qmetatype.h>
#if !defined(Q_MOC_OUTPUT_REVISION)
#error "The header file 'message_queue.h' doesn't include <QObject>."
...
QT_MOC_LITERAL(1, 13, 13), // "activeChanged"
QT_MOC_LITERAL(2, 27, 0), // ""
QT_MOC_LITERAL(3, 28, 6), // "active"
QT_MOC_LITERAL(4, 35, 11), // "sizeChanged"
QT_MOC_LITERAL(5, 47, 4), // "size"
QT_MOC_LITERAL(6, 52, 9), // "setActive"
QT_MOC_LITERAL(7, 62, 5) // "empty"

    },
    "MessageQueue\0activeChanged\0\0active\0"
    "sizeChanged\0size\0setActive\0empty"
};
...
void MessageQueue::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (MessageQueue::*_t)(bool );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&MessageQueue::activeChanged)) {
                *result = 0;
                return;
            }
        }
        {
            typedef void (MessageQueue::*_t)(int );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&MessageQueue::sizeChanged)) {
                *result = 1;
                return;
            }
        }
        ...
        case 2: *reinterpret_cast< bool*>(_v) = _t->size(); break;
        default: break;
        }
...
const QMetaObject MessageQueue::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_MessageQueue.data,
      qt_meta_data_MessageQueue,  qt_static_metacall, nullptr, nullptr}
};
...
// SIGNAL 0
void MessageQueue::activeChanged(bool _t1)
{
...
// SIGNAL 1
void MessageQueue::sizeChanged(int _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(&_t1)) };
