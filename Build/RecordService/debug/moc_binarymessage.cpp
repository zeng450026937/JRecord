...
QT_MOC_LITERAL(16, 172, 11), // "dataChanged"
QT_MOC_LITERAL(17, 184, 4), // "data"
...
QT_MOC_LITERAL(25, 264, 7), // "setData"
...
QT_MOC_LITERAL(28, 286, 4) // "make"
    ...
    "startpos\0statusChanged\0status\0dataChanged\0"
    "data\0setMode\0setUserId\0setDeviceUuid\0"
    "setUuid\0setTimestamp\0setStartpos\0"
    "setStatus\0setData\0parse\0message\0make"
};
...
static const uint qt_meta_data_BinaryMessage[] = {
 ...
 // properties: name, type, flags
      ...
      17, QMetaType::QByteArray, 0x00495103,
...
void BinaryMessage::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->modeChanged((*reinterpret_cast< qint32(*)>(_a[1]))); break;
        ...
        case 4: _t->timestampChanged((*reinterpret_cast< qint32(*)>(_a[1]))); break;
        case 5: _t->startposChanged((*reinterpret_cast< qint32(*)>(_a[1]))); break;
        case 6: _t->statusChanged((*reinterpret_cast< qint32(*)>(_a[1]))); break;
        case 7: _t->dataChanged((*reinterpret_cast< const QByteArray(*)>(_a[1]))); break;
        case 8: _t->setMode((*reinterpret_cast< qint32(*)>(_a[1]))); break;
        ...
        case 12: _t->setTimestamp((*reinterpret_cast< qint32(*)>(_a[1]))); break;
        case 13: _t->setStartpos((*reinterpret_cast< qint32(*)>(_a[1]))); break;
        case 14: _t->setStatus((*reinterpret_cast< qint32(*)>(_a[1]))); break;
        case 15: _t->setData((*reinterpret_cast< const QByteArray(*)>(_a[1]))); break;
        ...
        {
            typedef void (BinaryMessage::*_t)(qint32 );
        ...
        {
            typedef void (BinaryMessage::*_t)(const QByteArray & );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&BinaryMessage::dataChanged)) {
                *result = 7;
                return;
            }
        }
        ...
        void *_v = _a[0];
        switch (_id) {
        case 0: *reinterpret_cast< qint32*>(_v) = _t->mode(); break;
        ...
        case 4: *reinterpret_cast< qint32*>(_v) = _t->timestamp(); break;
        case 5: *reinterpret_cast< qint32*>(_v) = _t->startpos(); break;
        case 6: *reinterpret_cast< qint32*>(_v) = _t->status(); break;
        ...
        void *_v = _a[0];
        switch (_id) {
        case 0: _t->setMode(*reinterpret_cast< qint32*>(_v)); break;
        ...
        case 4: _t->setTimestamp(*reinterpret_cast< qint32*>(_v)); break;
        case 5: _t->setStartpos(*reinterpret_cast< qint32*>(_v)); break;
        case 6: _t->setStatus(*reinterpret_cast< qint32*>(_v)); break;
...
// SIGNAL 0
void BinaryMessage::modeChanged(qint32 _t1)
{
...
// SIGNAL 4
void BinaryMessage::timestampChanged(qint32 _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(&_t1)) };
...
// SIGNAL 5
void BinaryMessage::startposChanged(qint32 _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(&_t1)) };
...
// SIGNAL 6
void BinaryMessage::statusChanged(qint32 _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(&_t1)) };
...
// SIGNAL 7
void BinaryMessage::dataChanged(const QByteArray & _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(&_t1)) };
